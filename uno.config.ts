...
export default defineConfig({
  shortcuts: {
    ...
    'btn': 'px-3 sm:px-4 py-1 rounded inline-block bg-teal-600 text-white cursor-pointer hover:bg-teal-700 text-sm sm:text-base',
    'btn-secondary': 'px-3 sm:px-4 py-1 rounded inline-block bg-gray-600 text-white cursor-pointer hover:bg-gray-700 text-sm sm:text-base',
